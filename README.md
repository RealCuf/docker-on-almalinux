...
داکر (Docker) یک پلتفرم متن‌باز است که به شما اجازه می‌دهد نرم‌افزارها را به‌صورت کانتینر (Container) بسته‌بندی و اجرا کنید.
به زبان ساده‌تر، داکر کمک می‌کند برنامه‌هایت را طوری بسازی که در هر جایی دقیقاً همان‌طور کار کنند — فرقی ندارد روی لپ‌تاپ باشد، سرور، یا حتی ابر (Cloud).
